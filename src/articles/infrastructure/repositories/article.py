...
class AlchemyArticleRepo(ArticleRepo):
    ...
    async def update_article(self, article: EditArticle) -> None:
        ...
        query = (
            ...
            .values(article_dict)
            .filter(self._article.id == article_id)
        )
...
class AlchemyArticleReader(ArticleReader):
    ...
    def __init__(
        self,
        base: AlchemyReader,
        tag: AlchemyTagReader,
        sub_article: AlchemySubArticleReader,
    ) -> None:
        self._base = base
    ...
    async def get_specialization(
        ...
        return PaginatedDTO[SpecializationDTO](
            ...
            page=query.pagination.page,
            results=[
                SpecializationDTO(name=spec.name, id=spec.id)
